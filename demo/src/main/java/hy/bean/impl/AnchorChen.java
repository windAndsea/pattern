/*
 * @(#)AnchorChen.java    1.0.0 2018年7月16日 下午2:11:34
 *
 ...
 * 主播小陈.
 * 
 * @version 1.0.0 2018年7月16日 下午2:11:34
 * @author hy
 * @history 
 *			时间	版本	姓名	修改内容
 */
public class AnchorChen implements ISubject {

private List<IObserver> observers = Collections.synchronizedList(new ArrayList<IObserver>());
	
	private static final String NAME = "小陈";
